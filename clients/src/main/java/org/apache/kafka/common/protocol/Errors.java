...
import org.apache.kafka.common.errors.ExpectedOffsetIncorrectException;
...
public enum Errors {
    ...
    EXPECTED_OFFSET_INCORRECT(44,
        new ExpectedOffsetIncorrectException("Expected offset was incorrect."));
