...
object Defaults {
  ...
  val CompactionPolicyClass = kafka.server.Defaults.CompactionPolicyClass
}
...
case class LogConfig(props: java.util.Map[_, _]) extends AbstractConfig(LogConfig.configDef, props, false) {
  ...
  val compactionPolicyClass = getString(LogConfig.CompactionPolicyClassProp)
...
object LogConfig {
  ...
  val CompactionPolicyClassProp = "compactionPolicyClass"
  ...
  val CompactionPolicyClassDoc ="Class implementing CompactionPredicate to apply when performing log compaction."
  ...
  private val configDef = {
    ...
    new ConfigDef()
      ...
      .define(CompactionPolicyClassProp, STRING, Defaults.CompactionPolicyClass, MEDIUM, CompactionPolicyClassDoc)
  }
